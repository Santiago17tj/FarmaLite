                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="invoiceprint.php?id=<?php echo $row['id'] ?>&print=1" target="_blank"><button type="button" class="btn btn-xs btn-success" title="Imprimir en impresora USB"><i class="fa fa-print"></i> Imprimir</button></a>
